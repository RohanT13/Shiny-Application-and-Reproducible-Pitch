...
This presentation contains documentation for the Diamond price prediction application. The application can be found [**here**] ( https://rohanthite.shinyapps.io/Developing-Data-Product/)
...
Both files can be found here: [GitHub repo](https://github.com/RohanT13/Shiny-Application-and-Reproducible-Pitch)
